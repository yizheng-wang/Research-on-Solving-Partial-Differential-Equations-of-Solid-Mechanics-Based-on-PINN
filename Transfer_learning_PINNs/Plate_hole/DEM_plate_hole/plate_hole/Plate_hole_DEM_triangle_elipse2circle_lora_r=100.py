...
class DeepEnergyMethod:
    ...
    def __init__(self, model, numIntType, energy, dim, defect=False, r=0):
        # self.data = data
        self.model = MultiLayerNetLoRA(model[0], model[1], model[2], r=100)
    ...
    def train_model(self, data, neumannBC, dirichletBC, boundary_id, LHD, iteration, learning_rate):
        ...
        torch.save(self.model.state_dict(), f'model/model_elipse2circle_lora_r=100.pth')
    def getUST(self, x):
        '''
...
if __name__ == '__main__':
    ...
    cf.filename_out = '../../results/elipse2circle_lora/r=100'
    # 将坐标点先存起来
