...
class DeepEnergyMethod:
    ...
    def __init__(self, model, numIntType, energy, dim, defect=False, r=0, rank = 4):
        ...
        self.model.load_state_dict(torch.load('./model/model_elipse.pth'), strict = False)
    ...
    def train_model(self, data, neumannBC, dirichletBC, boundary_id, LHD, iteration, learning_rate):
        ...
        torch.save(self.model.state_dict(), f'model/model_elipse2circle_lora_r={self.rank}.pth')
    def getUST(self, x):
        '''
...
if __name__ == '__main__':
    ...
    for r in r_list:
        path = f'../../results/elipse2circle_lora/r={r}'
        # 检查路径是否存在，如果不存在则创建
        ...
        cf.filename_out = f'../../results/elipse2circle_lora/r={r}'
        # 将坐标点先存起来
