...
if __name__ == '__main__':
    ...
    # error_storage
    np.save("./output/dem_lora/r=1/FGM1to2_MLP_trap_L2_norm.npy", dem.L2_array)
    np.save("./output/dem_lora/r=1/FGM1to2_MLP_trap_H1_norm.npy", dem.H1_array)
    ...
    # error_storage
    np.save("./output/dem_lora/r=1/FGM2to1_MLP_trap_L2_norm.npy", dem.L2_array)
    np.save("./output/dem_lora/r=1/FGM2to1_MLP_trap_H1_norm.npy", dem.H1_array)
