...
for dd in range(50, 100):
    ...
    # %%
    nepoch_u0 = nepoch_u2 # PINN能量法大致2500循环收敛
    ...
    #plt.subplot(2, 2, 1)
    plt.figure(dpi=1000, figsize=(6, 5.5)) # cpinn和data driven的损失函数对比
    ...
    plt.legend(['精确解', 'Data driven', 'cPINN', 'CENN'], loc='upper right')
    plt.xlabel('x')
    plt.ylabel('u')
    plt.savefig('crack_position/y=0_up%i.png' % dd, bbox_inches = 'tight')
    plt.show()
    ...
    plt.legend(['精确解', 'Data driven', 'cPINN', 'CENN'], loc='upper left')
    plt.xlabel('x')
    plt.ylabel('u')
    plt.savefig('crack_position/y=0_down%i.png' % dd, bbox_inches = 'tight')
    plt.show()
    ...
    plt.xlabel('y')
    plt.ylabel('u')
    plt.savefig('crack_position/x=0_%i.png' % dd, bbox_inches = 'tight')
    plt.show()
    ...
    plt.savefig('crack_position/singular_strain_%i.png' % dd, bbox_inches = 'tight')
    plt.show()
