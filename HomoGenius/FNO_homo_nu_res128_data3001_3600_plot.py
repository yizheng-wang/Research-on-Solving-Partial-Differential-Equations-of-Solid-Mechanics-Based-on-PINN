...
def FNO_main(train_data_res, test_data_res, save_index):
    ...
    write_vtk_in('./Image/NTK_res128/dis_res128_data3001-3600_in', x_space, y_space, z_space, x_test_plot) #input
    
    y_test_p = np.ascontiguousarray(y_test_plot)
    out_p = np.ascontiguousarray(out_plot)
    
    write_vtk_dis('./Image/NTK_res128/dis_res128_data3001-3600_gt1', x_space, y_space, z_space, x_test_plot, np.ascontiguousarray(y_test_p[..., 0]), np.ascontiguousarray(y_test_p[..., 6]), np.ascontiguousarray(y_test_p[..., 12])) # GT load 1
    write_vtk_dis('./Image/NTK_res128/dis_res128_data3001-3600_gt2', x_space, y_space, z_space, x_test_plot, np.ascontiguousarray(y_test_p[..., 1]), np.ascontiguousarray(y_test_p[..., 7]), np.ascontiguousarray(y_test_p[..., 13])) # GT load 2
    write_vtk_dis('./Image/NTK_res128/dis_res128_data3001-3600_gt3', x_space, y_space, z_space, x_test_plot, np.ascontiguousarray(y_test_p[..., 2]), np.ascontiguousarray(y_test_p[..., 8]), np.ascontiguousarray(y_test_p[..., 14])) # GT load 3
    write_vtk_dis('./Image/NTK_res128/dis_res128_data3001-3600_gt4', x_space, y_space, z_space, x_test_plot, np.ascontiguousarray(y_test_p[..., 3]), np.ascontiguousarray(y_test_p[..., 9]), np.ascontiguousarray(y_test_p[..., 15])) # GT load 4
    write_vtk_dis('./Image/NTK_res128/dis_res128_data3001-3600_gt5', x_space, y_space, z_space, x_test_plot, np.ascontiguousarray(y_test_p[..., 4]), np.ascontiguousarray(y_test_p[..., 10]), np.ascontiguousarray(y_test_p[..., 16])) # GT load 5
    write_vtk_dis('./Image/NTK_res128/dis_res128_data3001-3600_gt6', x_space, y_space, z_space, x_test_plot, np.ascontiguousarray(y_test_p[..., 5]), np.ascontiguousarray(y_test_p[..., 11]), np.ascontiguousarray(y_test_p[..., 17])) # GT load 6
    
    write_vtk_dis('./Image/NTK_res128/dis_res128_data3001-3600_FNO1', x_space, y_space, z_space, x_test_plot, np.ascontiguousarray(out_p[..., 0]), np.ascontiguousarray(out_p[..., 6]), np.ascontiguousarray(out_p[..., 12])) # FNO load 1
    write_vtk_dis('./Image/NTK_res128/dis_res128_data3001-3600_FNO2', x_space, y_space, z_space, x_test_plot, np.ascontiguousarray(out_p[..., 1]), np.ascontiguousarray(out_p[..., 7]), np.ascontiguousarray(out_p[..., 13])) # FNO load 2
    write_vtk_dis('./Image/NTK_res128/dis_res128_data3001-3600_FNO3', x_space, y_space, z_space, x_test_plot, np.ascontiguousarray(out_p[..., 2]), np.ascontiguousarray(out_p[..., 8]), np.ascontiguousarray(out_p[..., 14])) # FNO load 3
    write_vtk_dis('./Image/NTK_res128/dis_res128_data3001-3600_FNO4', x_space, y_space, z_space, x_test_plot, np.ascontiguousarray(out_p[..., 3]), np.ascontiguousarray(out_p[..., 9]), np.ascontiguousarray(out_p[..., 15])) # FNO load 4
    write_vtk_dis('./Image/NTK_res128/dis_res128_data3001-3600_FNO5', x_space, y_space, z_space, x_test_plot, np.ascontiguousarray(out_p[..., 4]), np.ascontiguousarray(out_p[..., 10]), np.ascontiguousarray(out_p[..., 16])) # FNO load 5
    write_vtk_dis('./Image/NTK_res128/dis_res128_data3001-3600_FNO6', x_space, y_space, z_space, x_test_plot, np.ascontiguousarray(out_p[..., 5]), np.ascontiguousarray(out_p[..., 11]), np.ascontiguousarray(out_p[..., 17])) # FNO load 6    
...
if __name__ == "__main__":
    ...
    for i in data_number:
        input_PATH.append(f'./data_homogenization/matlab_data/FEM results/res128/3001-3600/nu_{i}.mat')   # input is 128*128*128 resolution
        output_PATH.append(f'./data_homogenization/matlab_data/FEM results/res128/3001-3600/displacement_{i}.mat')   # input is 128*128*128 resolution
