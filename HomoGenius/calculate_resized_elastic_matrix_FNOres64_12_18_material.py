...
if __name__ == "__main__":
    ...
    test_data = [num for num in test_num if 1201 <= num <= 1800]
    ...
    for i in range(start_train,end_train+1):
        ...
        mat_filename = r'data_homogenization/matlab_data/FEM results/res64/1201-1800_material/nu_%i.mat' % i
        ...
        GT_C_path = r'data_homogenization/matlab_data/FEM results/res64/1201-1800_material/CH_'+str(i)+'.mat'
    ...
    for i in test_data:
        ...
        # dis_filename = r'data_homogenization/matlab_data/FEM results/res64/1201-1800/displacement_%i.mat' % i
    ...
    np.save('./outdata/res64_data_type3_material/error_C_data1201_1800.npy', error_list)
    np.save('./outdata/res64_data_type3_material/error_thermal_data1201_1800.npy', error_thermal)
    ...
    plt.savefig('./Image/TPMS_forward_res64_type3_material/modulus_homo_res64_data1201_1800.png', dpi=1000)
    # 显示图形
    plt.show()
