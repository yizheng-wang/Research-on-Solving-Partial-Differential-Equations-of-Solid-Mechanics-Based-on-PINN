...
def FNO_main(train_data_res, test_data_res, save_index):
    ...
    np.save('./outdata/res128_data_type3/shuffled_indices.npy', shuffled_indices)
    # 使用这个索引数组来重新组织原数组
    ...
    torch.save(x_normalizer, 'x_normalizer_nu_res128_data_type3')
    torch.save(y_normalizer, 'y_normalizer_nu_res128_data_type3')
...
if __name__ == "__main__":
    ...
    np.save('./outdata/res128_data_type3/train_error_dic.npy', train_error_dic)
    np.save('./outdata/res128_data_type3/test_error_dic.npy', test_error_dic)
    np.save('./outdata/res128_data_type3/time_dic.npy', time_dic)
    
    np.save('./outdata/res128_data_type3/train_error_dis_x_1_dic.npy', train_error_dis_x_1_dic)
    np.save('./outdata/res128_data_type3/train_error_dis_x_2_dic.npy', train_error_dis_x_2_dic)
    np.save('./outdata/res128_data_type3/train_error_dis_x_3_dic.npy', train_error_dis_x_3_dic)
    np.save('./outdata/res128_data_type3/train_error_dis_x_4_dic.npy', train_error_dis_x_4_dic)
    np.save('./outdata/res128_data_type3/train_error_dis_x_5_dic.npy', train_error_dis_x_5_dic)
    np.save('./outdata/res128_data_type3/train_error_dis_x_6_dic.npy', train_error_dis_x_6_dic)
    
    np.save('./outdata/res128_data_type3/train_error_dis_y_1_dic.npy', train_error_dis_y_1_dic)
    np.save('./outdata/res128_data_type3/train_error_dis_y_2_dic.npy', train_error_dis_y_2_dic)
    np.save('./outdata/res128_data_type3/train_error_dis_y_3_dic.npy', train_error_dis_y_3_dic)
    np.save('./outdata/res128_data_type3/train_error_dis_y_4_dic.npy', train_error_dis_y_4_dic)
    np.save('./outdata/res128_data_type3/train_error_dis_y_5_dic.npy', train_error_dis_y_5_dic)
    np.save('./outdata/res128_data_type3/train_error_dis_y_6_dic.npy', train_error_dis_y_6_dic)
    
    np.save('./outdata/res128_data_type3/train_error_dis_z_1_dic.npy', train_error_dis_z_1_dic)
    np.save('./outdata/res128_data_type3/train_error_dis_z_2_dic.npy', train_error_dis_z_2_dic)
    np.save('./outdata/res128_data_type3/train_error_dis_z_3_dic.npy', train_error_dis_z_3_dic)
    np.save('./outdata/res128_data_type3/train_error_dis_z_4_dic.npy', train_error_dis_z_4_dic)
    np.save('./outdata/res128_data_type3/train_error_dis_z_5_dic.npy', train_error_dis_z_5_dic)
    np.save('./outdata/res128_data_type3/train_error_dis_z_6_dic.npy', train_error_dis_z_6_dic)
    
    np.save('./outdata/res128_data_type3/test_error_dis_x_1_dic.npy', test_error_dis_x_1_dic)
    np.save('./outdata/res128_data_type3/test_error_dis_x_2_dic.npy', test_error_dis_x_2_dic)
    np.save('./outdata/res128_data_type3/test_error_dis_x_3_dic.npy', test_error_dis_x_3_dic)
    np.save('./outdata/res128_data_type3/test_error_dis_x_4_dic.npy', test_error_dis_x_4_dic)
    np.save('./outdata/res128_data_type3/test_error_dis_x_5_dic.npy', test_error_dis_x_5_dic)
    np.save('./outdata/res128_data_type3/test_error_dis_x_6_dic.npy', test_error_dis_x_6_dic)
    
    np.save('./outdata/res128_data_type3/test_error_dis_y_1_dic.npy', test_error_dis_y_1_dic)
    np.save('./outdata/res128_data_type3/test_error_dis_y_2_dic.npy', test_error_dis_y_2_dic)
    np.save('./outdata/res128_data_type3/test_error_dis_y_3_dic.npy', test_error_dis_y_3_dic)
    np.save('./outdata/res128_data_type3/test_error_dis_y_4_dic.npy', test_error_dis_y_4_dic)
    np.save('./outdata/res128_data_type3/test_error_dis_y_5_dic.npy', test_error_dis_y_5_dic)
    np.save('./outdata/res128_data_type3/test_error_dis_y_6_dic.npy', test_error_dis_y_6_dic)
    
    np.save('./outdata/res128_data_type3/test_error_dis_z_1_dic.npy', test_error_dis_z_1_dic)
    np.save('./outdata/res128_data_type3/test_error_dis_z_2_dic.npy', test_error_dis_z_2_dic)
    np.save('./outdata/res128_data_type3/test_error_dis_z_3_dic.npy', test_error_dis_z_3_dic)
    np.save('./outdata/res128_data_type3/test_error_dis_z_4_dic.npy', test_error_dis_z_4_dic)
    np.save('./outdata/res128_data_type3/test_error_dis_z_5_dic.npy', test_error_dis_z_5_dic)
    np.save('./outdata/res128_data_type3/test_error_dis_z_6_dic.npy', test_error_dis_z_6_dic)