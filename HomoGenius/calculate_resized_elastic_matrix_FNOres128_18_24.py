...
if __name__ == "__main__":
    ...
    x_normalizer = torch.load('./x_normalizer_nu_res128_data1801_2400')
    y_normalizer = torch.load('./y_normalizer_nu_res128_data1801_2400')
    y_normalizer.cuda()
    ...
    for i in range(start,end+1):
        ...
        print(r'FNO model for prediction of C: error %.4f' % error_C)
    np.save('./outdata/res128_data_type3/error_C_data1801_2400.npy', error_list)
    np.save('./outdata/res128_data_type3/error_thermal_data1801_2400.npy', error_thermal)
    ...
    plt.savefig('./Image/TPMS_forward_res128_type3/modulus_homo_res128_data1801_2400.png', dpi=1000)
    # 显示图形
    plt.show()    
