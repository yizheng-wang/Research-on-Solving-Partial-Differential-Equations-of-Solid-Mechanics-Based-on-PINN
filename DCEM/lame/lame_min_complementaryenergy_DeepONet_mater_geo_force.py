...
plt.legend(['Exact', 'DCEM_%i' % (nepoch1+nepoch2+nepoch3), 'DCEM-O_%i' % (nepoch1+nepoch2+nepoch3), 'DCEM_%i' % (nepoch1+nepoch2+nepoch3+nepoch), 'DCEM-O_%i' % (nepoch1+nepoch2+nepoch3+nepoch)])
plt.show()
...
plt.plot(L2loss_array_mincomplement, ls = ':')
