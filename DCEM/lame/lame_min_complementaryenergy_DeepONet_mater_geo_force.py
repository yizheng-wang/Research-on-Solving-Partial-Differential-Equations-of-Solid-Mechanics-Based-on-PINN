...
for epoch in range(nepoch1):
    ...
    def closure():  
        ...
        L2loss_array_mincomplementD.append(torch.abs((L2norm_fai_pred - L2norm_fai_exact)/L2norm_fai_exact))
...
for epoch in range(nepoch1):
    ...
    def closure():  
        ...
        L2loss_array_mincomplement.append(torch.abs((L2norm_fai_pred - L2norm_fai_exact)/L2norm_fai_exact))
...
plt.savefig('./pic/sigma_rr_DCM_10.png', dpi=1000, transparent=True)
plt.show()
# zy最小余能误差
...
plt.xlabel('x', fontsize=13)
plt.ylabel('y', fontsize=13)
plt.savefig('./pic/sigma_theta_DCM_10.png', dpi=1000, transparent=True)
plt.show()
...
plt.xlabel('x', fontsize=13)
plt.ylabel('y', fontsize=13)
plt.savefig('./pic/dis_r_DCM_10.png', dpi=1000, transparent=True)
plt.show()
...
plt.xlabel('x', fontsize=13)
plt.ylabel('y', fontsize=13)
plt.savefig('./pic/sigma_rr_DCMO_10.png', dpi=1000, transparent=True)
plt.show()
# zy最小余能误差
...
plt.xlabel('x', fontsize=13)
plt.ylabel('y', fontsize=13)
plt.savefig('./pic/sigma_theta_DCMO_10.png', dpi=1000, transparent=True)
plt.show()
# dis_r最小余能误差
...
plt.xlabel('x', fontsize=13)
plt.ylabel('y', fontsize=13)
plt.savefig('./pic/dis_r_DCMO_10.png', dpi=1000, transparent=True)
plt.show()
...
plt.xlabel('x', fontsize=13)
plt.ylabel('y', fontsize=13)
plt.savefig('./pic/sigma_rr_DCM_30.png', dpi=1000, transparent=True)
plt.show()
# zy最小余能误差
...
plt.xlabel('x', fontsize=13)
plt.ylabel('y', fontsize=13)
plt.savefig('./pic/sigma_theta_DCM_30.png', dpi=1000, transparent=True)
plt.show()
# dis_r最小余能误差
...
plt.xlabel('x', fontsize=13)
plt.ylabel('y', fontsize=13)
plt.savefig('./pic/dis_r_DCM_30.png', dpi=1000, transparent=True)
plt.show()
...
plt.xlabel('x', fontsize=13)
plt.ylabel('y', fontsize=13)
plt.savefig('./pic/sigma_rr_DCMO_30.png', dpi=1000, transparent=True)
plt.show()
# zy最小余能误差
...
plt.xlabel('x', fontsize=13)
plt.ylabel('y', fontsize=13)
plt.savefig('./pic/sigma_theta_DCMO_30.png', dpi=1000, transparent=True)
plt.show()
# dis_r最小余能误差
...
plt.xlabel('x', fontsize=13)
plt.ylabel('y', fontsize=13)
plt.savefig('./pic/dis_r_DCMO_30.png', dpi=1000, transparent=True)
plt.show()
...
plt.xlabel('x', fontsize=13)
plt.ylabel('y', fontsize=13)
plt.savefig('./pic/sigma_rr_DCM_50.png', dpi=1000, transparent=True)
plt.show()
# zy最小余能误差
...
plt.xlabel('x', fontsize=13)
plt.ylabel('y', fontsize=13)
plt.savefig('./pic/dis_r_DCM_50.png', dpi=1000, transparent=True)
plt.show()
...
plt.xlabel('x', fontsize=13)
plt.ylabel('y', fontsize=13)
plt.savefig('./pic/sigma_rr_DCMO_50.png', dpi=1000, transparent=True)
plt.show()
# zy最小余能误差
...
plt.xlabel('x', fontsize=13)
plt.ylabel('y', fontsize=13)
plt.savefig('./pic/sigma_theta_DCMO_50.png', dpi=1000, transparent=True)
plt.show()
# dis_r最小余能误差
...
plt.xlabel('x', fontsize=13)
plt.ylabel('y', fontsize=13)
plt.savefig('./pic/dis_r_DCMO_50.png', dpi=1000, transparent=True)
plt.show()
#%% 
# =============================================================================
...
plt.scatter(r_numpy[::2], predline_sigma_rr_0D[::2], marker = '*')
...
plt.legend(['Exact', "Data-driven", 'DCEM_%i' % (nepoch1+nepoch2+nepoch3), 'DCEM-O_%i' % (nepoch1+nepoch2+nepoch3), 'DCEM_%i' % (nepoch1+nepoch2+nepoch3+nepoch), 'DCEM-O_%i' % (nepoch1+nepoch2+nepoch3+nepoch)])
plt.savefig('./pic/sigma_rr_DCM_DCMO.png', dpi=1000, transparent=True)
plt.show()

plt.plot(r_numpy, exactline_sigma_theta, color = 'r')
plt.scatter(r_numpy[::2], predline_sigma_theta_0D[::2], marker = '*')
...
plt.legend(['Exact', "Data-driven", 'DCEM_%i' % (nepoch1+nepoch2+nepoch3), 'DCEM-O_%i' % (nepoch1+nepoch2+nepoch3), 'DCEM_%i' % (nepoch1+nepoch2+nepoch3+nepoch), 'DCEM-O_%i' %  (nepoch1+nepoch2+nepoch3+nepoch)])
plt.savefig('./pic/sigma_theta_DCM_DCMO.png', dpi=1000, transparent=True)
plt.show()

plt.plot(r_numpy, exactline_dis_r, color = 'r')
plt.scatter(r_numpy[::2], predline_dis_r_0D[::2], marker = '*')
...
plt.legend(['Exact', "Data-driven", 'DCEM_%i' % (nepoch1+nepoch2+nepoch3), 'DCEM-O_%i' % (nepoch1+nepoch2+nepoch3), 'DCEM_%i' %  (nepoch1+nepoch2+nepoch3+nepoch), 'DCEM-O_%i' %  (nepoch1+nepoch2+nepoch3+nepoch)])
plt.savefig('./pic/dis_r_DCM_DCMO.png', dpi=1000, transparent=True)
plt.show()

#%% error L2
end = 5000
plt.plot(L2loss_array_mincomplement[:end], ls = ':')
plt.plot(L2loss_array_mincomplementD[:end], linestyle='--')
plt.xlabel('Training steps', fontsize=13)
plt.ylabel(r'$\mathcal{L}_{2}^{rel}$ error', fontsize=13)
plt.yscale('log')
plt.legend(['DCEM', 'DCEM-O'])
plt.savefig('./pic/L2_DCM_DCMO.png', dpi=1000, transparent=True)
plt.show()

plt.plot(H1loss_array_mincomplement[:end], ls = ':')
plt.plot(H1loss_array_mincomplementD[:end], linestyle='--')
plt.xlabel('Training steps', fontsize=13)
plt.ylabel(r'$\mathcal{H}_{1}^{rel}$ error', fontsize=13)
plt.yscale('log')
plt.legend(['DCEM', 'DCEM-O'])
plt.savefig('./pic/H1_DCM_DCMO.png', dpi=1000, transparent=True)
plt.show()
