...
# 分析sigma应力，输入坐标是极坐标r和theta
    r = np.linspace(0, l, N_test)
    theta = np.linspace(0, alpha, N_test) # y方向N_test个点
...
#     return theta, pred_sigma_r, pred_sigma_theta, pred_sigma_rtheta
...
# =============================================================================
r_mesh, theta_mesh, pred_sigma_r_com, pred_sigma_theta_com, pred_sigma_rtheta_com = evaluate_sigma_contourf(N_contour)
...
r_mesh, theta_mesh, pred_sigma_r_str, pred_sigma_theta_str, pred_sigma_rtheta_str = evaluate_sigma_contourf(N_contour)
...
# rr预测剪应力
h4 = plt.contourf(x_mesh, y_mesh, pred_sigma_r_com,  cmap = 'jet', levels = 100)
plt.gca().invert_yaxis()
ax = plt.gca()
ax.set_aspect(1)
plt.colorbar(h4).ax.set_title(r'$\sigma_{r}$', fontsize=13)
plt.xlabel('x')
plt.ylabel('y')
plt.show()
# theta预测剪应力
h5 = plt.contourf(x_mesh, y_mesh, pred_sigma_theta_com,  cmap = 'jet', levels = 100)
plt.gca().invert_yaxis()
ax = plt.gca()
ax.set_aspect(1)
plt.colorbar(h5).ax.set_title(r'$\sigma_{\theta}$', fontsize=13)
plt.xlabel('x')
plt.ylabel('y')
plt.show()
# rtheta预测剪应力
h6 = plt.contourf(x_mesh, y_mesh, pred_sigma_rtheta_com,  cmap = 'jet', levels = 100)
plt.gca().invert_yaxis()
ax = plt.gca()
ax.set_aspect(1)
plt.colorbar(h6).ax.set_title(r'$\tau_{r\theta}$', fontsize=13)
plt.xlabel('x')
plt.ylabel('y')
plt.show()
...
# rr误差
h7 = plt.contourf(x_mesh, y_mesh, np.abs(exact_sigma_r - pred_sigma_r_com),  cmap = 'jet', levels = 100)
plt.gca().invert_yaxis()
ax = plt.gca()
ax.set_aspect(1)
plt.colorbar(h7).ax.set_title(r'$\sigma_{r}$', fontsize=13)
plt.xlabel('x')
plt.ylabel('y')
plt.show()
# theta误差
h8 = plt.contourf(x_mesh, y_mesh, np.abs(exact_sigma_theta - pred_sigma_theta_com),  cmap = 'jet', levels = 100)
plt.gca().invert_yaxis()
ax = plt.gca()
ax.set_aspect(1)
plt.colorbar(h8).ax.set_title(r'$\sigma_{\theta}$', fontsize=13)
plt.xlabel('x')
plt.ylabel('y')
plt.show()
# rtheta误差
h9 = plt.contourf(x_mesh, y_mesh, np.abs(exact_sigma_rtheta - pred_sigma_rtheta_com),  cmap = 'jet', levels = 100)
plt.gca().invert_yaxis()
ax = plt.gca()
ax.set_aspect(1)
plt.colorbar(h9).ax.set_title(r'$\tau_{r\theta}$', fontsize=13)
plt.xlabel('x')
plt.ylabel('y')
plt.show()
...
# rr误差
h10 = plt.contourf(x_mesh, y_mesh, np.abs(exact_sigma_r - pred_sigma_r_str),  cmap = 'jet', levels = 100)
plt.gca().invert_yaxis()
ax = plt.gca()
ax.set_aspect(1)
...
plt.show()
# theta误差
h11 = plt.contourf(x_mesh, y_mesh, np.abs(exact_sigma_theta - pred_sigma_theta_str),  cmap = 'jet', levels = 100)
plt.gca().invert_yaxis()
ax = plt.gca()
ax.set_aspect(1)
...
plt.show()
# rtheta误差
h12 = plt.contourf(x_mesh, y_mesh, np.abs(exact_sigma_rtheta - pred_sigma_rtheta_str),  cmap = 'jet', levels = 100)
plt.gca().invert_yaxis()
ax = plt.gca()
ax.set_aspect(1)
