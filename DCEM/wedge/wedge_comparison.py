...
# =============================================================================
theta_dom, pred_sigma_r_com, pred_sigma_theta_com, pred_sigma_rtheta_com, pred_dis_r_com = evaluate_sigma(N_test)
...
theta_dom, pred_sigma_r_str, pred_sigma_theta_str, pred_sigma_rtheta_str, pred_dis_r_str = evaluate_sigma(N_test)
exact_sigma_r = 2*c*((alpha-theta_dom)-np.sin(theta_dom)**2*np.tan(alpha)-np.sin(theta_dom)*np.cos(theta_dom))
exact_sigma_theta = 2*c*((alpha-theta_dom) + np.sin(theta_dom)*np.cos(theta_dom)-np.cos(theta_dom)**2*np.tan(alpha))   
exact_sigma_rtheta = -c*(-1 + np.cos(2*theta_dom) + np.sin(2*theta_dom)*np.tan(alpha))
exact_epsilon_r = 1/E*(exact_sigma_r - nu*exact_sigma_theta)
...
plt.scatter(theta_dom[::internal], pred_sigma_r_com[::internal], marker = '*', linestyle='-')
plt.scatter(theta_dom[::internal], pred_sigma_r_str[::internal], c='m',  marker = '+', linestyle='-')
plt.xlabel(r'$\theta$', size=size_n)
plt.ylabel(r'$\sigma_{r}$', size=size_n)
plt.legend(['Exact', 'DCEM', 'PINN strong form: stress function'])
settick()
plt.show()

plt.plot(theta_dom, exact_sigma_theta, color = 'r')
plt.scatter(theta_dom[::internal], pred_sigma_theta_com[::internal], marker = '*', linestyle='-')
plt.scatter(theta_dom[::internal], pred_sigma_theta_str[::internal], c='m',  marker = '+', linestyle='-')
plt.xlabel(r'$\theta$', size=size_n)
plt.ylabel(r'$\sigma_{\theta}$', size=size_n)
plt.legend(['Exact', 'DCEM', 'PINN strong form: stress function'])
settick()
plt.show()

plt.plot(theta_dom, exact_sigma_rtheta, color = 'r')
plt.scatter(theta_dom[::internal], pred_sigma_rtheta_com[::internal], marker = '*', linestyle='-')
plt.scatter(theta_dom[::internal], pred_sigma_rtheta_str[::internal], c='m',  marker = '+', linestyle='-')
plt.xlabel(r'$\theta$', size=size_n)
plt.ylabel(r'$\tau_{r\theta}$', size=size_n)
plt.legend(['Exact', 'DCEM', 'PINN strong form: stress function'])
settick()
plt.show()

plt.plot(r_dom, exact_dis_r, color = 'r')
plt.scatter(r_dom[::internal], pred_dis_r_com[::internal], marker = '*', linestyle='-')
plt.scatter(r_dom[::internal], pred_dis_r_str[::internal], c='m',  marker = '+', linestyle='-')
plt.xlabel(r'$x$', size=size_n)
plt.ylabel(r'$u_{r}$', size=size_n)
plt.legend(['Exact', 'DCEM', 'PINN strong form: stress function'])
settick()
plt.show()
