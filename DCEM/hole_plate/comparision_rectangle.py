...
from DCEM_rectangle import (dom as DCEM_dom,
...
from DEM_rectangle import ( dom as DEM_dom,
...
surf = ax.scatter(node_coordinate_abaqus_rectangle[:, 0], node_coordinate_abaqus_rectangle[:, 1], c = FEM_mise, cmap=cm.rainbow)# vmin=0, vmax=0.14, 
...
plt.rcParams['font.family'] = 'Times New Roman'
fig, ax = plt.subplots(figsize=(5.8, 4.8)) 
surf = ax.scatter(node_coordinate_abaqus_rectangle[:, 0], node_coordinate_abaqus_rectangle[:, 1], c = FEM_stress11, cmap=cm.rainbow)# vmin=0, vmax=0.14, 
#cbar = fig.colorbar(ax)
cb = fig.colorbar(surf)
cb.ax.locator_params(nbins=7)
cb.ax.tick_params(labelsize=16)
...
plt.rcParams['font.family'] = 'Times New Roman'
fig, ax = plt.subplots(figsize=(5.8, 4.8)) 
surf = ax.scatter(node_coordinate_abaqus_rectangle[:, 0], node_coordinate_abaqus_rectangle[:, 1], c = FEM_stress12, cmap=cm.rainbow)# vmin=0, vmax=0.14, 
#cbar = fig.colorbar(ax)
cb = fig.colorbar(surf)
cb.ax.locator_params(nbins=7)
cb.ax.tick_params(labelsize=16)
...
plt.rcParams['font.family'] = 'Times New Roman'
fig, ax = plt.subplots(figsize=(5.8, 4.8)) 
surf = ax.scatter(DEM_dom[:, 0], DEM_dom[:, 1], c = DEM_mise, cmap=cm.rainbow)# vmin=0, vmax=0.14, 
#cbar = fig.colorbar(ax)
cb = fig.colorbar(surf)
cb.ax.locator_params(nbins=7)
cb.ax.tick_params(labelsize=16)
...
plt.rcParams['font.family'] = 'Times New Roman'
fig, ax = plt.subplots(figsize=(5.8, 4.8)) 
surf = ax.scatter(DEM_dom[:, 0], DEM_dom[:, 1], c = DEM_stress11, cmap=cm.rainbow)# vmin=0, vmax=0.14, 
#cbar = fig.colorbar(ax)
cb = fig.colorbar(surf)
cb.ax.locator_params(nbins=7)
cb.ax.tick_params(labelsize=16)
...
plt.rcParams['font.family'] = 'Times New Roman'
fig, ax = plt.subplots(figsize=(5.8, 4.8)) 
surf = ax.scatter(DEM_dom[:, 0], DEM_dom[:, 1], c = DEM_stress12, cmap=cm.rainbow)# vmin=0, vmax=0.14, 
#cbar = fig.colorbar(ax)
cb = fig.colorbar(surf)
cb.ax.locator_params(nbins=7)
cb.ax.tick_params(labelsize=16)
...
plt.rcParams['font.family'] = 'Times New Roman'
fig, ax = plt.subplots(figsize=(5.8, 4.8)) 
surf = ax.scatter(DCEM_dom[:, 0], DCEM_dom[:, 1], c = DCEM_mise, cmap=cm.rainbow)# vmin=0, vmax=0.14, 
#cbar = fig.colorbar(ax)
cb = fig.colorbar(surf)
cb.ax.locator_params(nbins=7)
cb.ax.tick_params(labelsize=16)
...
plt.rcParams['font.family'] = 'Times New Roman'
fig, ax = plt.subplots(figsize=(5.8, 4.8)) 
surf = ax.scatter(DCEM_dom[:, 0], DCEM_dom[:, 1], c = DCEM_stress11, cmap=cm.rainbow)# vmin=0, vmax=0.14, 
#cbar = fig.colorbar(ax)
cb = fig.colorbar(surf)
cb.ax.locator_params(nbins=7)
cb.ax.tick_params(labelsize=16)
...
plt.rcParams['font.family'] = 'Times New Roman'
fig, ax = plt.subplots(figsize=(5.8, 4.8)) 
surf = ax.scatter(DCEM_dom[:, 0], DCEM_dom[:, 1], c = DCEM_stress12, cmap=cm.rainbow)# vmin=0, vmax=0.14, 
#cbar = fig.colorbar(ax)
cb = fig.colorbar(surf)
cb.ax.locator_params(nbins=7)
cb.ax.tick_params(labelsize=16)
...
plt.plot(FEM_node_x05[:, 1][:int(len(FEM_node_x05)/2+1)] , FEM_mise_x05[:int(len(FEM_node_x05)/2+1)])
plt.plot(FEM_node_x05[:, 1][:int(len(FEM_node_x05)/2+1)], DEM_mise_x05[:int(len(FEM_node_x05)/2+1)], linestyle='-.')
plt.plot(FEM_node_x05[:, 1][:int(len(FEM_node_x05)/2+1)], DCEM_mise_x05[:int(len(FEM_node_x05)/2+1)], linestyle=':')
...
# =============================================================================
plt.figure(figsize=(10, 7))
plt.plot(FEM_node_x10[:, 1][:int(len(FEM_node_x10)/2+1)] , FEM_mise_x10[:int(len(FEM_node_x10)/2+1)])
plt.plot(FEM_node_x10[:, 1][:int(len(FEM_node_x10)/2+1)], DEM_mise_x10[:int(len(FEM_node_x10)/2+1)], linestyle='-.')
plt.plot(FEM_node_x10[:, 1][:int(len(FEM_node_x10)/2+1)], DCEM_mise_x10[:int(len(FEM_node_x10)/2+1)], linestyle=':')
...
# =============================================================================
plt.figure(figsize=(10, 7))
plt.plot(FEM_node_y05[:, 0][:int(len(FEM_node_y05)/2+1)] , FEM_mise_y05[:int(len(FEM_node_y05)/2+1)])
plt.plot(FEM_node_y05[:, 0][:int(len(FEM_node_y05)/2+1)], DEM_mise_y05[:int(len(FEM_node_y05)/2+1)], linestyle='-.')
plt.plot(FEM_node_y05[:, 0][:int(len(FEM_node_y05)/2+1)], DCEM_mise_y05[:int(len(FEM_node_y05)/2+1)], linestyle=':')
...
# error
plt.figure(figsize=(10, 7))
plt.plot(DEM_error_sigma_x_array, linestyle='-.')
plt.plot(DCEM_error_sigma_x_array, linestyle='-.')
plt.plot(DEM_error_sigma_y_array, linestyle=':')
plt.plot(DCEM_error_sigma_y_array, linestyle=':')
plt.plot(DEM_error_sigma_xy_array, linestyle='--')
plt.plot(DCEM_error_sigma_xy_array, linestyle='--')
plt.plot(DEM_error_sigma_mise_array)
plt.plot(DCEM_error_sigma_mise_array)
plt.yscale('log')
