...
def run_scale_law(layers, grid_size, epoch_num=2500):
    model_p1 = KAN(layers, base_activation=torch.nn.SiLU, grid_size=grid_size, grid_range=[-1.0, 1.0], spline_order=3).cuda()
    model_p2 = KAN(layers, base_activation=torch.nn.SiLU, grid_size=grid_size, grid_range=[-1.0, 1.0], spline_order=3).cuda()
