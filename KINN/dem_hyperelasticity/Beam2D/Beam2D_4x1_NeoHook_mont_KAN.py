...
class DeepEnergyMethod:
    ...
    def train_model(self, shape, dxdydz, data, neumannBC, dirichletBC, LHD, iteration, learning_rate):
...
if __name__ == '__main__':
    ...
    dem = DeepEnergyMethod([cf.D_in, 5,5,5, cf.D_out], 'montecarlo', mat, 2)
    ...
    dxdy = [cf.hx, cf.hy]
    cf.iteration = 1000
    cf.filename_out = "./output/dem/NeoHook_KAN_mont"
    cf.lr = 0.001
    dem.train_model(shape, dxdy, dom, boundary_neumann, boundary_dirichlet, [cf.Length, cf.Height, cf.Depth], cf.iteration, cf.lr)
    ...
    util.write_vtk_v2p("./output/dem/NeoHook_KAN_mont_disy_error", points, dis_y_abs_error)
    
    # error_storage
    np.save("./output/dem/NeoHook_KAN_mont_L2_norm.npy", dem.L2_array)
    np.save("./output/dem/NeoHook_KAN_mont_H1_norm.npy", dem.H1_array)
    ...
    np.save("./output/dem/NeoHook_KAN_mont_y05.npy", dict_y05)
    ...
    np.save("./output/dem/NeoHook_KAN_mont_x2.npy", dict_x2)
