...
if __name__ == '__main__':
    ...
    dxdy = [cf.hx, cf.hy]
    cf.iteration = 1000
    cf.filename_out = "./output/dem/NeoHook_MLP_simp"
    cf.lr = 0.001
    ...
    util.write_vtk_v2p("./output/dem/NeoHook_MLP_simp_disy_error", points, dis_y_abs_error)
    
    # error_storage
    np.save("./output/dem/NeoHook_MLP_simp_L2_norm.npy", dem.L2_array)
    np.save("./output/dem/NeoHook_MLP_simp_H1_norm.npy", dem.H1_array)
    ...
    np.save("./output/dem/NeoHook_MLP_simp_y05.npy", dict_y05)
    ...
    np.save("./output/dem/NeoHook_MLP_simp_x2.npy", dict_x2)
