...
def evaluate_model(model, epoch):
    ...
    plt.xlabel('x')
    plt.ylabel('y')
    plt.savefig(f'./PINNs_results/KAN_pred_con_K_epoch{epoch}.pdf', dpi=300)
    plt.show() 
    ...
    plt.xlabel('x')
    plt.ylabel('y')
    plt.savefig(f'./PINNs_results/KAN_error_con_K_epoch{epoch}.pdf', dpi=300)
    plt.show() 
...
np.save('PINNs_results/con_K_kan_loss.npy', loss_list)
np.save('PINNs_results/con_K_kan_l2.npy', error_list)
...
plt.savefig('./PINNs_results/loss_con_K.pdf', dpi=300)
plt.show()
