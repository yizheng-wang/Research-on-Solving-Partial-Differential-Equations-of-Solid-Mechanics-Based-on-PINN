...
def plot_inner(Grids0,Net,N,area=np.array([0,0,2,2])):
    ...
    draw_colormap(x,fvalue,title)
    write_arr2DVTK('../output_ntk/error_BINN_MLP', x, error_abs, 'error_binn')
...
if __name__=='__main__': 
    ...
    if trainmode==True:
        ...
        Xerr = Bie_trainer_rizzo_again.train_partitial_rizzo_again_efficient_mode(Grids0,Bienet,device,workspace,20000,0.001,Netinvname0) #性能模式
        ...
        #np.save( '../results/flower_BINN_MLP_error.npy', error_array)        
