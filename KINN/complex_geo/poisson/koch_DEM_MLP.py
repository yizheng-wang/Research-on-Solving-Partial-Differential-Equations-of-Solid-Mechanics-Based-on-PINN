...
write_arr2DVTK('./output_ntk/pred_DEM_MLP', dom_koch_n, u_pred, 'pred_energy')

write_arr2DVTK('./output_ntk/error_DEM_MLP', dom_koch_n, error, 'error_energy')
...
np.save('./results/koch_DEM_MLP_error.npy', error_array)
plt.yscale('log')
