...
if __name__ == '__main__':
    ...
    np.save('../../abaqus_reference/coordinate.npy', dom_aba)
    ...
    #*****************************************************************************************************************************************
    util.write_vtk_v2p(cf.filename_out+'/Plate_hole_KINN_DEM', dom_aba, U, U_mag, S11, S12, S13, S22, S23, S33, E11, E12, E13, E22, E23, E33, SVonMises, U_mag_error, MISES_error)
    surUx, surUy, surUz = U
...
#  compare the disy and mises(x=0), and disx (y=0)
    ...
    plt.plot(x0, pred_disy_r, color = 'blue', label = 'KINN_', lw = 2)
    plt.xlabel('Y') 
    plt.ylabel('Dis_Y')
    plt.legend()
    plt.show()
    ...
    plt.plot(x0, pred_mise_r, color = 'blue', label = 'KINN', lw = 2)
    plt.xlabel('Y') 
    plt.ylabel('Mises')
    plt.legend()
    plt.show()
    ...
    plt.plot(y0, pred_disx_r, color = 'blue', label = 'KINN', lw = 2)
    plt.xlabel('X') 
    plt.ylabel('Dis_X')
    plt.legend()
    plt.show()
