...
from DEM.crack import define_structure_quarter as des
...
if __name__ == '__main__':
    ...
    dem.plot_distance_contourf(datatest )
    dem.plot_distance(datatest )
    shape = [cf.Nx, cf.Ny]
    dxdy = [cf.hx, cf.hy]
    iters = [10000]
    pred_mise_array = []
    for iter_e in iters:
        ...
        pred_mise_array.append(pred_mise_r)
        plt.plot(y0-10, pred_mise_r, label = 'deep Nitsche ritz solution_iter%i' % iter_e, lw = 2)
