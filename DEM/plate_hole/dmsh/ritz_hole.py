...
if __name__ == '__main__':
    for i in range(1):
        ...
        dxdy = [cf.hx, cf.hy]
        cf.iteration = 9000
        cf.filename_out = "./output/ritz_P%iPlate_hole_2Layer_mesh%i_iter%i_dmshLBFGS" % (penalty_boundary_loss, len(dom), cf.iteration)
